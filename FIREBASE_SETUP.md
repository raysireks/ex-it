...
4.  **Name**: `FIREBASE_SERVICE_ACCOUNT_EX_IT`
5.  **Value**: Paste the entire contents of the downloaded JSON file.
6.  Click **Add secret**.

## Project ID

The current configuration uses `ex-it-demo-project` as the project ID. You MUST change this in `.firebaserc` and `.github/workflows/deploy.yml` to your actual Firebase project ID.
